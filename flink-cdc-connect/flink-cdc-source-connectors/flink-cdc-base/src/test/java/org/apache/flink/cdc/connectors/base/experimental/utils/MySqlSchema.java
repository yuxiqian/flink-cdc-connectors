...
import static org.apache.flink.cdc.connectors.base.experimental.utils.MySqlConnectionUtils.createMySqlDatabaseSchema;
                    ...
                    rs -> {
                        if (rs.next()) {
                            ...
                            final MySqlPartition partition =
                                    new MySqlPartition(connectorConfig.getLogicalName(), null);
