...
import static org.apache.flink.cdc.connectors.stimps.source.StimpsSourceOptions.DISTRIBUTED_TABLES;
...
public class StimpsDataFactory implements DataSourceFactory {
    ...
    public DataSource createDataSource(Context context) {
        ...
        return new StimpsDataSource(tableCount, distributedTables);
    }
