...
public class MySqlDataSourceOptions {
    ...
    @Experimental
    public static final ConfigOption<Boolean> PARSE_GH_OST_SCHEMA_CHANGES =
            ConfigOptions.key("parse.gh-ost.schema.changes")
                    .booleanType()
                    .defaultValue(false)
                    .withDescription(
                            "Whether to parse schema change events generated by gh-ost utilities. Defaults to false.");
}
