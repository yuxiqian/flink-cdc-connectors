...
type: docs
aliases:
- /connectors/cdc-sources-for-flink/oceanbase-cdc
---
<!--
...
You can also try the quickstart tutorial that sync data from OceanBase to Elasticsearch, please refer [Flink CDC Tutorial]({{< ref "docs/connectors/cdc-sources-for-flink/tutorials/oceanbase-tutorial" >}}) for more information.
