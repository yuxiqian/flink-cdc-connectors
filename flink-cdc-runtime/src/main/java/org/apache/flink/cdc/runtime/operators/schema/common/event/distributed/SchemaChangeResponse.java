...
/** Mapper's request to {@link SchemaCoordinator} for reducing an incompatible schema. */
public class SchemaChangeResponse implements CoordinationResponse {
    ...
    public SchemaChangeResponse(List<SchemaChangeEvent> reducedSchemaResult, int reduceSeqNum) {
