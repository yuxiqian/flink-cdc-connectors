...
/**
 * The request from {@link SchemaOperator} to {@link SchemaRegistry} to asking for permission to
 * start a schema change.
 */
public class AskForSchemaChangePermissionRequest implements CoordinationRequest {
    ...
    public AskForSchemaChangePermissionRequest(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AskForSchemaChangePermissionRequest)) {
            return false;
        }
        AskForSchemaChangePermissionRequest that = (AskForSchemaChangePermissionRequest) o;
