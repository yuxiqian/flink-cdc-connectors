...
public class BlockUpstreamRequest implements OperatorEvent {
    ...
    public BlockUpstreamRequest(int reduceSeqNum) {
    ...
    public boolean equals(Object o) {
        ...
        return reduceSeqNum == that.reduceSeqNum;
    }

    @Override
    public int hashCode() {
        return Objects.hash(reduceSeqNum);
    }

    @Override
    public String toString() {
        return "BlockUpstreamRequest{reduceSeqNum=" + reduceSeqNum + '}';
    }
}
