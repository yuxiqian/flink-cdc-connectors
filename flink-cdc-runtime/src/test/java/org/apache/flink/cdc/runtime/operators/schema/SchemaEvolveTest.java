...
public class SchemaEvolveTest {
    ...
    public void testEvolveSchema() throws Exception {
        ...
        // Test CreateTableEvent
        {
            ...
            Assertions.assertThat(
                            ListUtils.union(
                                    Collections.singletonList(new FlushEvent()),
        ...
        // Test AddColumnEvent
        {
            ...
            Assertions.assertThat(
                    ...
                    .isEqualTo(
                            ListUtils.union(
                                    Collections.singletonList(new FlushEvent()), addColumnEvents));
        ...
        // Test DropColumnEvent
        {
            ...
            Assertions.assertThat(
                    ...
                    .isEqualTo(
                            ListUtils.union(
                                    Collections.singletonList(new FlushEvent()), dropColumnEvents));
    ...
    public void testTryEvolveSchemaWithFailure() throws Exception {
        ...
        // Test AddColumnEvent
        {
            ...
            expectedEvents.add(new FlushEvent());
