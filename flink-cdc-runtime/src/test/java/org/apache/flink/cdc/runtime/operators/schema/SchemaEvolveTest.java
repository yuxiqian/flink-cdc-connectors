...
public class SchemaEvolveTest {
    ...
    public void testEvolveSchema() throws Exception {
        ...
        // Test CreateTableEvent
        {
            ...
            Assertions.assertThat(
                            ListUtils.union(
                                    Collections.singletonList(new FlushEvent(tableId, 1L)),
        ...
        // Test AddColumnEvent
        {
            ...
            Assertions.assertThat(
                    ...
                    .isEqualTo(
                            ListUtils.union(
                                    Collections.singletonList(new FlushEvent(tableId, 2L)),
                                    addColumnEvents));
        ...
        // Test RenameColumnEvent
        {
            ...
            Assertions.assertThat(
                    ...
                    .isEqualTo(
                            ListUtils.union(
                                    Collections.singletonList(new FlushEvent(tableId, 3L)),
                                    renameColumnEvents));
        ...
        // Test AlterColumnTypeEvent
        {
            ...
            Assertions.assertThat(
                    ...
                    .isEqualTo(
                            ListUtils.union(
                                    Collections.singletonList(new FlushEvent(tableId, 4L)),
        ...
        // Test DropColumnEvent
        {
            ...
            Assertions.assertThat(
                    ...
                    .isEqualTo(
                            ListUtils.union(
                                    Collections.singletonList(new FlushEvent(tableId, 5L)),
                                    dropColumnEvents));
    ...
    public void testTryEvolveSchemaWithFailure() throws Exception {
        ...
        // Test AddColumnEvent
        {
            ...
            expectedEvents.add(new FlushEvent(tableId, 2L));
        ...
        // Test RenameColumnEvent
        {
            ...
            List<Event> expectedEvents = new ArrayList<>();
            expectedEvents.add(new FlushEvent(tableId, 3L));
