...
public class DataChangeEventWithSchemaSerializerTest
        extends SerializerTestBase<DataChangeEventWithSchema> {
    @Override
    protected TypeSerializer<DataChangeEventWithSchema> createSerializer() {
        return DataChangeEventWithSchemaSerializer.INSTANCE;
    }
    ...
    @Override
    protected Class<DataChangeEventWithSchema> getTypeClass() {
        return DataChangeEventWithSchema.class;
    }

    @Override
    protected DataChangeEventWithSchema[] getTestData() {
